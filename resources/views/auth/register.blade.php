                            ...
                            <div class="register-form">
                                <form method="POST" action="{{ route('register') }}" name="register-form" class="needs-validation" novalidate="">
                                    ...
                                    <div class="d-flex align-items-center mb-3 pb-2">
                                        <p class="m-0">
                                            {{ __('Your personal data will be used to support your experience throughout this website, to
                                    ...
                                    <div class="customer-option mt-4 text-center">
                                        <span class="text-secondary">{{ __('Have an account?') }}</span>
                                        <a href="{{ route('login') }}" class="btn-text js-show-register">{{ __('Login to your Account') }}</a>
                                    </div>
                                </form>
                            </div>
                        </div>
