            ...
            <ul class="nav nav-tabs mb-5" id="login_register" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link nav-link_underscore active" id="login-tab" data-bs-toggle="tab" href="#tab-item-login"
                       role="tab" aria-controls="tab-item-login" aria-selected="true">{{ __('Login') }}</a>
                </li>
            </ul>
                    ...
                    <div class="login-form">
                        <form method="POST" action="{{ route('login') }}" name="login-form" class="needs-validation" novalidate="">
                            ...
                            <div class="customer-option mt-4 text-center">
                                <span class="text-secondary">{{ __('No account yet?') }}</span>
                                <a href="{{ route('register') }}" class="btn-text js-show-register">{{ __('Create Account') }}</a> | <a href="my-account.html" class="btn-text js-show-register">{{ __('My Account') }}</a>
                            </div>
                        </form>
                    </div>
                </div>
